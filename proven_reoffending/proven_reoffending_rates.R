...
# The following R code recreates the figures published in the Ministry of Justice's 
# Proven Re-offending Statistics Quarterly Bulletin, April 2013 to March 2014

# Read and tidy the Ministry of Justice's proven re-offending and index disposal data.
# https://www.gov.uk/government/uploads/system/uploads/attachment_data/file/495646/CSVs.zip
